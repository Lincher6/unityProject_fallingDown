...
public class SpawnManager : MonoBehaviour
{
    ...
    public GameObject[] movingPlatfroms;
    ...
    private IEnumerator TopFallingRoutine()
    {
        ...
        {
            TopSpikes.instance.FallSequance();
    ...
    private IEnumerator SpiderRoutine()
    {
        ...
        while (!gm.IsGameStopped())
        {
            Instantiate(spiderRope, transform.position, Quaternion.identity);
            yield return new WaitForSeconds(15);
        }
    }
    ...
    private void SpawnPlatform()
    {
        ...
        {
            currentPlatform = Instantiate(movingPlatfroms[Random.Range(0, 2)], spawnPosition, Quaternion.identity).GetComponent<PlatformInfo>();
        }
